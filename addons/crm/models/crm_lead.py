...
class Lead(models.Model):
    ...
    # Adding Sister Company as multi selection
    sister_company_ids = fields.Many2many(

    'res.company',

    'crm_lead_company_rel', # Relation table name

    'lead_id', # Field for the lead

    'company_id', # Field for the company

    string='Sister Companies',

    help="Select sister companies for which this lead is created."
    ...
    partner_id = fields.Many2one(
        ...
        #options={'no_create': False} # Allow creating new partners
        domain="[('is_company', '=', True)]", # Optional: restrict to companies if needed
        )
